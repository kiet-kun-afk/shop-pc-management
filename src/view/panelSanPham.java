...
public class panelSanPham extends JPanel {
	...
	boolean checkLoi(String ma, String ten, String gia, String moTa) {
		...
		if (moTa.equals("")) {
			...
			lblDescribe.setForeground(new Color(0, 0, 0));
		}
		return true;
	}

	boolean checkLoiUpdate(String ma, String ten, String gia, String moTa) {
		if (!BatLoi.Ma(ma) || !checkMa(ma)) {
			lblID.setForeground(new Color(255, 0, 0));
			return false;
		} else {
